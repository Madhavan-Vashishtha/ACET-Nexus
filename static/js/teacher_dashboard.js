...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadMyClasses() {
        ...
        container.innerHTML = "";
        selClass.innerHTML = '<option value="">-- Choose Section --</option>';
        assignSelClass.innerHTML = '<option value="">-- Choose Section --</option>';
    ...
    // ================= 5. LOAD ASSIGNMENTS & SUBMISSIONS =================
    ...
    document.getElementById("postedAssignmentsContainer").addEventListener("click", async (e) => {
